...
router.post('/car/:id/update', upload.single('picture'), car_controller.car_update_post);
...
router.post('/maker/create', upload.single('logo'), maker_controller.maker_create_post);
...
router.post('/maker/:id/update', upload.single('logo'), maker_controller.maker_update_post);
